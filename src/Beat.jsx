...
function Beat(props) {
    ...
    return (
        <>
        <div onClick={props.click} className={"select-none font-mono flex items-center justify-center min-w-6 flex-1 h-20 border-3 rounded-2xl " + colorsList[props.type]}>
            <div>
