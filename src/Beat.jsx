...
function Beat(props) {
    ...
    return (
        <>
        <div onClick={props.click} className={"select-none font-mono flex items-center justify-center min-w-8 flex-1 h-20 mx-1 border-3 rounded-2xl " + colorsList[props.type]}>
            <div>
